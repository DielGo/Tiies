...
<body class="is-preload">
    <div id="page-wrapper">
        ...
        <header id="header">
            ...
            <nav id="nav">
                <ul>
                    <li><a href="Administrar.php" class="button">Admin</a></li>
                </ul>
            </nav>
        </header>
        ...
        <section id="main" class="container medium">
            ...
            <br>
            <div class="boox">
                <form method="POST" action="backend/EliminarUser.php">
                    <ul class="actions special">
                        <li><input type="int" name="id" value="" placeholder="Id Usuario" required /></li>
                    </ul>
                    <ul class="actions special">
